...
public class MealsUtil {
    ...
    public static void main(String[] args) {
        ...
        TimeUtil.formatLocalDateTime(meals.get(0).getDateTime(), "dd.MM.yyyy HH:mm");
    }
    ...
    public static List<MealTo> filtered(List<Meal> meals, int caloriesPerDay, Predicate<? super Meal> predicate) { //Predicate<? super Meal > predicate) {
